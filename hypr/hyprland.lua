...
hl.monitor({ output = "DP-2", mode = "1920x1080@59.99", position = "0x-1080", scale = "1" })
...
hl.on("hyprland.start", function () 
   ...
   hl.exec_cmd("waybar")
   hl.exec_cmd("alsactl restore -f ~/.config/alsa/asound.state")
 end)
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(000000ee)"} },
...
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd("alsactl restore -f ~/.asound.state"))
